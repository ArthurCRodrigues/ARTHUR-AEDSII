...
class HashTable {
    ...
    private int rIndex; // Índice da próxima posição livre na área de reserva

    // Construtor
    public HashTable() {
        table = new String[TOTAL_SIZE];
        rIndex = MAIN_AREA_SIZE; // Começa no início da área de reserva
    }
    ...
    public boolean search(String name) {
        ...
        for (int i = MAIN_AREA_SIZE; i < rIndex; i++) {
