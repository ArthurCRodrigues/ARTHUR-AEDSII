...
class CreatureSequential {
    ...
    public CreatureSequential(int id, int gen, String creatureName, String creatureDescription, List<String> elementTypes, List<String> skills,
